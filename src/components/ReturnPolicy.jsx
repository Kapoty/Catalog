	...
	render() {
		...
		return <React.Fragment>
			...
			<Typography variant="body1" align='center' gutterBottom>
				<p>Em caso de troca ou devolução será necessário o preenchimento da <Link href="https://docs.google.com/forms/d/e/1FAIpQLSehLpz0rvO-DIH0zYE-iGbNTimdeqJ0t5evaHGCB5JV7HUmRg/viewform" target="_blank">solicitação de Troca/Devolução</Link></p>
